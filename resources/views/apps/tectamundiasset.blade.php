@extends('layouts.vertical', ['page_title' => 'Tecta Mundi Asset', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Tecta Mundi Asset</a></li>
                        <li class="breadcrumb-item active">Informations</li>
                    </ol>
                </div>
                <h4 class="page-title">Tecta Mundi Asset</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
        ...
        <div class="col-xl-8 col-lg-7">
            ...
            <div class="card d-block">
                <div class="card-body">
                    ...
                    <h4 class="mt-2">Tecta Mundi Asset</h4>
                    ...
                    <p class="text-muted">
                        The Tecta Mundi Asset website is currently under construction.
                    </p>
                    <h5 class="mb-3 d-inline-block">Live Link:</h5>
                    <a href="https://tectamundiasset.com/" target="_blank" class="text-muted d-inline-block">
                    tectamundiasset.com
                    </a>
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <div class="w-100 color-box d-flex flex-wrap" style="gap: 10px;">
                                    <div class="d-flex flex-column align-items-center">
                                        <div class="color" style="background-color: #77192A; width: 30px; height: 30px;"></div>
                                        <span class="mt-2">#77192A</span>
                                    </div>
                                    <div class="d-flex flex-column align-items-center">
                                        <div class="color" style="background-color: #818385; width: 30px; height: 30px;"></div>
                                        <span class="mt-2">#818385</span>
                                    </div>
                                    <div class="d-flex flex-column align-items-center">
                                        <div class="color" style="background-color: #abadad; width: 30px; height: 30px;"></div>
                                        <span class="mt-2">#abadad</span>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-xl-4 col-lg-5">
                    ...
                    <div class="card mb-1 shadow-none border">
                        <div class="p-2">
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <div class="avatar-sm">
                                        <span class="avatar-title bg-primary-subtle text-primary rounded">
                                            <img src="/images/logos/tecta-mundi-asset-logo.png" alt="logo" width="40">
                                        </span>
                                    </div>
                                </div>
                                <div class="col ps-0">
                                ...
                                <div class="col-auto">
                                    <!-- Button -->
                                    <a href="{{env('APP_URL')}}/images/logos/tecta-mundi-asset-logo.png" class="btn btn-link fs-16 text-muted" download="quand-logo">
                        ...
                        <div class="p-2">
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <div class="avatar-sm">
                                        <span class="avatar-title bg-primary-subtle text-primary rounded">
                                            <img src="/images/logos/tecta-mundi-fav-icon.png" alt="logo" width="18">
                                        </span>
                                    </div>
                                </div>
                                <div class="col ps-0">
                                ...
                                <div class="col-auto">
                                    <!-- Button -->
                                    <a href="{{env('APP_URL')}}/images/logos/tecta-mundi-fav-icon.png" class="btn btn-link fs-16 text-muted" download="favicon-quand">
                                        <i class="ri-download-line"></i>
                                    </a>
                                </div>
                            </div>
            ...
            <div class="card-body card cta-box text-bg-info">
                <div class="text-center">
                    <h3 class="m-0 fw-normal cta-box-title">Go to <b>Tecta Mundi Asset's</b> Developer Website.</h3>
                    <img class="my-3" src="/images/svg/startman.svg" width="138" alt="Generic placeholder image">
                    <br />
                    <a href="{{ route('second', ['apps', 'tectamundiassetdev']) }}" class="btn btn-sm btn-light rounded-pill">
