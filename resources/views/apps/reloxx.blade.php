@extends('layouts.vertical', ['page_title' => 'Reloxx', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Reloxx</a></li>
                            <li class="breadcrumb-item active">Informations</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Reloxx</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-xl-8 col-lg-7">
                ...
                <div class="card d-block">
                    <div class="card-body">
                        ...
                        <h4 class="mt-2">Reloxx Website</h4>
                        ...
                        <p class="text-muted">
                            This website, utilized by Reloxx, is constructed with WordPress, a robust and flexible content management system. This choice provides developers with ease of use, extensive plugin support, and scalability advantages.
                        </p>
                        <h5 class="mb-3 d-inline-block">Live Link:</h5>
                        <a href="https://reloxx.co.uk/" target="_blank" class="text-muted d-inline-block">
                            reloxx.co.uk
                        </a>
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="w-100 color-box d-flex flex-wrap" style="gap: 10px;">
                                        <div class="d-flex flex-column align-items-center">
                                            <div class="color" style="background-color: #17252a; width: 30px; height: 30px;"></div>
                                        ...
                                        <div class="d-flex flex-column align-items-center">
                                            <div class="color" style="background-color: #25292a; width: 30px; height: 30px;"></div>
                                            <span class="mt-2">#25292a</span>
                                        </div>
                                        <div class="d-flex flex-column align-items-center">
                                            <div class="color" style="background-color: #46707f; width: 30px; height: 30px;"></div>
                                            <span class="mt-2">#46707f</span>
                                        </div>
                                        <div class="d-flex flex-column align-items-center">
                                            <div class="color" style="background-color: #777771; width: 30px; height: 30px;"></div>
                                            <span class="mt-2">#777771</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-xl-4 col-lg-5">
                                    ...
                                    <div class="col-auto">
                                        <div class="avatar-sm">
                                            <span class="avatar-title bg-primary-subtle text-primary rounded">
                                                <img src="/images/logos/reloxx_logo.png" alt="logo" width="40">
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col ps-0">
                            ...
                            <div class="p-2">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <div class="avatar-sm">
                                            <span class="avatar-title bg-primary-subtle text-primary rounded">
                                                <img src="/images/logos/favicon-rl.png" alt="logo" width="18">
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col ps-0">
                ...
                <div class="text-center">
                    <h3 class="m-0 fw-normal cta-box-title">Go to <b>Reloxx's</b> Developer Website.</h3>
                    <img class="my-3" src="/images/svg/startman.svg" width="138" alt="Generic placeholder image">
                    <br />
                    <a href="{{ route('second', ['apps', 'reloxxdev']) }}" class="btn btn-sm btn-light rounded-pill">
