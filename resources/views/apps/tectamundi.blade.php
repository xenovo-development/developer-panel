@extends('layouts.vertical', ['page_title' => 'Tecta Mundi', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Tecta Mundi</a></li>
                        <li class="breadcrumb-item active">Informations</li>
                    </ol>
                </div>
                <h4 class="page-title">Tecta Mundi</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
        ...
        <div class="col-xl-8 col-lg-7">
            ...
            <div class="card d-block">
                <div class="card-body">
                    ...
                    <p class="text-muted">
                        The Tecta Mundi website is currently under construction.
                    </p>
                    <h5 class="mb-3 d-inline-block">Live Link:</h5>
                    <a href="https://tectamundi.at/" target="_blank" class="text-muted d-inline-block">
                    tectamundi.at
                    </a>
                    <div class="row">
                        <div class="col-md-4">
        ...
        <div class="col-xl-4 col-lg-5">
                    ...
                    <div class="card mb-1 shadow-none border">
                        <div class="p-2">
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <div class="avatar-sm">
                                        <span class="avatar-title bg-primary-subtle text-primary rounded">
                                            <img src="/images/logos/tectamundi-logo.png" alt="logo" width="40">
                                        </span>
                                    </div>
                                </div>
                                <div class="col ps-0">
                                ...
                                <div class="col-auto">
                                    <!-- Button -->
                                    <a href="{{env('APP_URL')}}/images/logos/tectamundi-logo.png" class="btn btn-link fs-16 text-muted" download="quand-logo">
            ...
            <div class="card-body card cta-box text-bg-info">
                <div class="text-center">
                    <h3 class="m-0 fw-normal cta-box-title">Go to <b>Tecta Mundi's</b> Developer Website.</h3>
                    <img class="my-3" src="/images/svg/startman.svg" width="138" alt="Generic placeholder image">
                    <br />
                    <a href="{{ route('second', ['apps', 'tectamundidev']) }}" class="btn btn-sm btn-light rounded-pill">
