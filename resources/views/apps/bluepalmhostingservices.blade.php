@extends('layouts.vertical', ['page_title' => 'Blue Palm Hosting Services', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
        ...
        <div class="col-xl-8 col-lg-7">
            ...
            <div class="card d-block">
                <div class="card-body">
                    ...
                    <h4 class="mt-2">Blue Palm Hosting Services Website</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <div class="w-100">
                                    <h5 class="mt-1">
                                    Blue Palm Hosting Services Website
                                    </h5>
                                </div>
                            </div>
                            <!-- end due date -->
                    ...
                    The website of Blue Palm Hosting Services was developed using Vue.js and Nuxt, and it was made accessible in German, English, and Turkish languages. Features like Nuxt's multi-language support enhance user experience by effectively reaching diverse target audiences.                    </p>

                    <h5 class="mb-3 d-inline-block">Live Link:</h5>
                    <a href="https://info.bluepalm.rentals/" target="_blank" class="text-muted d-inline-block">
                    info.bluepalm.rentals
                    </a>
                    <div class="row">
                        <div class="col-md-4">
        ...
        <div class="card">
                ...
                <div class="card mb-1 shadow-none border">
                    <div class="p-2">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <div class="avatar-sm">
                                    <span class="avatar-title bg-primary-subtle text-primary rounded">
                                        <img src="/images/logos/bp-hs-logo-v2.png" alt="logo" width="40">
                                    </span>
                                </div>
                            </div>
                            <div class="col ps-0">
                            ...
                            <div class="col-auto">
                                <!-- Button -->
                                <a href="{{env('APP_URL')}}/images/logos/bp-hs-logo-v2.png" class="btn btn-link fs-16 text-muted" download="hostingeurope_logo">
            ...
            <div class="card-body card cta-box text-bg-info">
                <div class="text-center">
                    <h3 class="m-0 fw-normal cta-box-title">Go to <b>Blue Palm Hosting Services's</b> Developer Website.</h3>
                    <img class="my-3" src="/images/svg/startman.svg" width="138" alt="Generic placeholder image">
                    <br />
                    <a href="{{ route('second', ['apps', 'bluepalmhostingservicesdev']) }}" class="btn btn-sm btn-light rounded-pill">
